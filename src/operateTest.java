...
//                getProb(tempLine);
    ...
    public  void readToMap(){
        String filePath = "E:\\1\\SplitData\\1\\test";
        try{
            Map<String,Map<String,String>> testMap=  file2Map.readFileByLine(filePath,10);
    ...
    public  static String getFileProb(String OriginclassName,String txtString){
        Map<String, Map<String,Double>> keyword = operateGetClassTopK.getClassTopKMap();
        Map<String, List<Map.Entry<String, Double>>> list_Data = operateGetClassTopK.getClassTopK(keyword);
